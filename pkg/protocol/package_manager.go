...
func InitPackageManager(ctx context.Context, ethStateContracts map[string]*abi.State, circuitsPath string, didResolverHandler packers.DIDResolverHandlerFunc) (*iden3comm.PackageManager, error) {
