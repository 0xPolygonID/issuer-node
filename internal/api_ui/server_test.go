...
func TestServer_CheckStatus(t *testing.T) {
	...
	server := NewServer(&cfg, identityService, claimsService, schemaService, NewConnectionsMock(), NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), &health.Status{},nil,nil)
...
func TestServer_AuthCallback(t *testing.T) {
	server := NewServer(&cfg, NewIdentityMock(), NewClaimsMock(), NewSchemaMock(), NewConnectionsMock(), NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), &health.Status{},nil,nil)
	handler := getHandler(context.Background(), server)
...
func TestServer_AuthQRCode(t *testing.T) {
	...
	server := NewServer(&cfg, identityService, NewClaimsMock(), NewSchemaMock(), NewConnectionsMock(), NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
...
func TestServer_GetSchema(t *testing.T) {
	...
	server := NewServer(&cfg, NewIdentityMock(), NewClaimsMock(), schemaSrv, NewConnectionsMock(), NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
	issuerDID, err := core.ParseDID("did:polygonid:polygon:mumbai:2qE1BZ7gcmEoP2KppvFPCZqyzyb5tK9T6Gec5HFANQ")
	require.NoError(t, err)
	server.cfg.APIUI.IssuerDID = *issuerDID
	server.cfg.APIUI.ServerURL = "https://testing.env"
...
func TestServer_DeleteConnection(t *testing.T) {
	...
	server := NewServer(&cfg, NewIdentityMock(), claimsService, NewSchemaMock(), connectionsService, NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
	server.cfg.APIUI.IssuerDID = *issuerDID
	handler := getHandler(context.Background(), server)
...
func TestServer_DeleteConnectionCredentials(t *testing.T) {
	...
	connectionsService := services.NewConnection(connectionsRepository, storage)
	server := NewServer(&cfg, NewIdentityMock(), NewClaimsMock(), NewSchemaMock(), connectionsService, NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
	handler := getHandler(context.Background(), server)
...
func TestServer_DeleteCredential(t *testing.T) {
	...
	server := NewServer(&cfg, NewIdentityMock(), claimsService, NewSchemaMock(), NewConnectionsMock(), NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
	handler := getHandler(context.Background(), server)
...
func TestServer_CreateLink(t *testing.T) {
	...
	cfg.APIUI.IssuerDID = *did
	server := NewServer(&cfg, NewIdentityMock(), claimsService, NewSchemaMock(), connectionsService, linkService, NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
...
func TestServer_GetStateStatus(t *testing.T) {
	...
	cfg.APIUI.IssuerDID = *did
	server := NewServer(&cfg, identityService, claimsService, NewSchemaMock(), connectionsService, NewLinkMock(), NewPublisherMock(), NewPackageManagerMock(), nil,nil,nil)
