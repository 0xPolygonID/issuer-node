...
// MediaTypeManager manages the list of allowed media types for the packagemanager message type
...
// AllowMediaType check if the packagemanager message supports the mediaType type
