...
// The public key is in the format of a PEM encoded SubjectPublicKeyInfo.
// The SubjectPublicKeyInfo is ASN.1 DER encoded.
// if this key is generated by some of the supported curves by the default lib,
// you can use ParsePKIXPublicKey directly to parse it. However, Secp256k1 curve is not supported by the default lib.
// So, we need to parse it manually.
//func DecodeAWSETHPubKey(ctx context.Context, key []byte) (*ecdsa.PublicKey, error) {
...
//	}
//
//	_, err := asn1.Unmarshal(toUnmarshal, &pki)
//	if err != nil {
