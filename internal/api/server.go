...
func NewServer(cfg *config.Configuration, identityService ports.IdentityService, claimsService ports.ClaimsService, packageManager *iden3comm.PackageManager) *Server {
	return &Server{
		cfg:             cfg,
