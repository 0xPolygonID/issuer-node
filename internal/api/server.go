...
type Server struct {
	...
	identityStateService ports.IdentityStateService
}

// NewServer is a Server constructor
func NewServer(cfg *config.Configuration, identityService ports.IndentityService, claimsService ports.ClaimsService, schemaService ports.SchemaService, identityStateService ports.IdentityStateService) *Server {
	return &Server{
		cfg:                  cfg,
