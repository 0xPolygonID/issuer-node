...
func NewServer(cfg *config.Configuration, identityService ports.IdentityService, claimsService ports.ClaimsService, schemaService ports.SchemaService, packageManager *iden3comm.PackageManager) *Server {
	return &Server{
		cfg:             cfg,
