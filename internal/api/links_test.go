	...
	for _, tc := range []testConfig{
		...
		},
		{
			...
			body: CreateLinkRequest{
				...
				Expiration:           common.ToPointer(time.Date(2029, 8, 15, 14, 30, 45, 100, time.Local)),
		...
		},
		{
			...
			body: CreateLinkRequest{
				...
				CredentialExpiration: common.ToPointer(time.Date(2029, 8, 15, 14, 30, 45, 100, time.Local)),
				LimitedClaims:        common.ToPointer(10),
				CredentialSubject:    CredentialSubject{"birthday": 19790911, "documentType": 12},
				MtProof:              true,
				SignatureProof:       true,
