...
func TestGetClaimsIssuedForUserID(t *testing.T) {
	...
	link := domain.NewLink(*did, common.ToPointer[int](10), &tomorrow, schemaID, &nextWeek, true, false, domain.CredentialSubject{}, nil, nil, common.ToPointer(verifiable.Iden3commRevocationStatusV1))
