...
const fromHexChar = (c: number): number => {
...
const encode = (src: Uint8Array): Uint8Array => {
...
const encodeString = (b: Uint8Array): string => new TextDecoder().decode(encode(b));

const fromLittleEndian = (bytes: Uint8Array): bigint => {
...
const schemaIdToBytes = (schemaId: Uint8Array): Uint8Array => {
